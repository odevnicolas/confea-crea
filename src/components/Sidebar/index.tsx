      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <div className="mb-4 px-6 ml-[-1em]">
            <div className="relative">
              <select
                value={selectedCrea}
                onChange={(e) => setSelectedCrea(e.target.value)}
                className="block appearance-none w-full bg-[#14171C] text-white py-4 px-4 pr-12 leading-tight focus:outline-none focus:bg-gray-700 focus:border-gray-500"
              >
