...
import { ArtTableList } from '../../components/Tables/ListART/artTableList';
    ...
    <DefaultLayout>
      ...
      <div className='grid grid-cols-4 gap-4'>
        <div className='col-span-3 bg-gray-200 p-4'>
          ...
          <ArtTableList page={'home'} activeTab={'registered'} loading={false} setTableActive={function (newState: string): void {
        ...
        <div className='col-span-1 bg-gray-300 p-4'>
          <div>
            <PaymentCard artNumber={'ART123456'} paymentStatus={'Não pago'} />
            <PaymentCard artNumber={'ART123456'} paymentStatus={'Pago'} />
            <PaymentCard artNumber={'ART123456'} paymentStatus={'Pago'} />
          </div>
        </div>
      </div>
